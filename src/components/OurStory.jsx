      ...
      <Accordion defaultActiveKey="1">
        <Accordion.Item className="accr">
          ...
          <Accordion.Body className="acc-body">
            ...
            restaurant wesite. Templates are available on the application to
            make your restaurant page unique and eye catching. Also, customers
            have various options to choose from the list of local restaurant and
            enjoy their authentic dishes.
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
      <br />
